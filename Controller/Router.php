    ...
    RouteHandler::post('/login', [new AuthController(), 'loginUser']);
        ...
        RouteHandler::group(['prefix' => '/EmployeeManager'], function() {
                  ...
                  RouteHandler::get('/inventory', function () {
                    ...
                    RouteHandler::get('/employeeList', function () {
                     ...
                     RouteHandler::get('/pos', function () {
                         (new POSController())->posSystem();
                    });
                     RouteHandler::get('/reportDashboard', function () {
                         (new EmployeeManagerController())->userCurrentPage("Reports/reportDashboard");
                    });
                     RouteHandler::get('/salesReport', function () {
                         (new EmployeeManagerController())->userCurrentPage("Reports/salesReport");
                    });
          ...
          //  RouteHandler::get('/dashboard', [new UserController(), 'userDashBoard']);
                    ...
                    RouteHandler::group(['prefix' => '/POS'], function() {
                     RouteHandler::post('/updateCart', function () {
                         (new POSController())->updateCart();
                    });

                     RouteHandler::get("/loadItem", function () {
                         (new POSController())->loadMoreItem();
                    });
                        RouteHandler::post('/addToCart', function () {
                         (new POSController())->addToCart();
                    });
               ...
               RouteHandler::group(['prefix' => '/Dashboard'], function() {
                     RouteHandler::get('/barGraph', function () {
                         (new DashboardController())->salesBarGraph();
                    });
                    RouteHandler::get('/pieGraph', function () {
                         (new DashboardController())->salesPieGraph();
                    });
               });

                RouteHandler::group(['prefix' => '/Report'], function() {
                         RouteHandler::get('/lineGraph', function () {
                         (new ReportController())->lineGraph();
                    });
                    ...
                    RouteHandler::get('/computeItemRevenue', function () {
                     ...
                     RouteHandler::get('/TimelineRevenue', function () {
                         (new ReportController())->timelineRevenue();
                    });
               });  
